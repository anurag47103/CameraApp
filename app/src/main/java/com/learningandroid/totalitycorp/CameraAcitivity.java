...
import com.learningandroid.totalitycorp.databinding.ActivityMainBinding;
...
public class CameraAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(allPermissionsGranted()) {
            ...
            ActivityCompat.requestPermissions(CameraAcitivity.this,
                    ALL_PERMISSION,
        ...
        imageCapture.takePicture(
                ...
                new ImageCapture.OnImageSavedCallback() {
                    ...
                    public void onImageSaved(@NonNull ImageCapture.OutputFileResults outputFileResults) {
                        ...
                        Toast.makeText(CameraAcitivity.this, msg, Toast.LENGTH_SHORT).show();
                        Log.d(TAG, msg);
                        Intent editIntent = new Intent(CameraAcitivity.this, EditActivity.class);
    ...
    private boolean allPermissionsGranted() {
        for(String permission : ALL_PERMISSION) {
            if (ContextCompat.checkSelfPermission(CameraAcitivity.this, permission) != PackageManager.PERMISSION_GRANTED) {
                return false;
            }
        }
        return true;
